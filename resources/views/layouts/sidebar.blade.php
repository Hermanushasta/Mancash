        ...
        <ul class="flex flex-col w-full">
            ...
            <li class="my-px">
                <a href="{{ route('anggotaView') }}"
                    ...
                    {{-- <span
                        class="flex items-center justify-center text-xs text-red-500 font-semibold bg-red-100 h-6 px-2 rounded-full ml-auto">1k
                    </span> --}}
                </a>
            </li>
            ...
            <li class="my-px">
                <a href="{{ route('pemasukanView') }}"
                    ...
                    <span class="ml-3">Pemasukan Kas</span>
                    {{-- <span
            ...
            <li class="my-px">
                <a href="{{ route('tambahPengeluaran') }}"
                    ...
                    <span class="ml-3">Catat Pengeluaran</span>
                </a>
            </li>
            <li class="my-px">
                <a href="{{ route('pengeluaranView') }}"
                    ...
                    <span class="ml-3">Daftar Pengeluaran</span>
                </a>
            </li>
        </ul>
    </div>
